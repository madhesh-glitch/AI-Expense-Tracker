...
# LLM Configuration
LLM_API_ENDPOINT = "https://api.openai.com/v1/chat/completions"  # Replace with your LLM endpoint
LLM_API_KEY = os.getenv("OPENAI_API_KEY")  # Make sure to set this in your environment
...
pytesseract.pytesseract.tesseract_cmd = '/opt/homebrew/bin/tesseract'  # Intel Mac
...
client = MongoClient("mongodb+srv://Madhesh_M_A:madhesh1K@ai-cluster.kkow4qb.mongodb.net/?retryWrites=true&w=majority&appName=AI-Cluster")
db = client["ai_expenses"]
users_col = db["users"]
...
def upload_receipt():
    ...
    try:
        ...
        print("📸 OCR text extracted:", text[:300])  # Show first 300 characters
    except Exception as e:
    ...
    try:
        ...
        print("✅ Category:", category, "💰 Amount:", amount, "🧭 Assessment:", assessment)
    except Exception as e:
        print("❌ Amount calc error:", traceback.format_exc())
    ...
    print("💾 Expense saved to MongoDB for:", current_user.email)
